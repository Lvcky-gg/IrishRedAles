    ...
    return (
        <div className="breweryCardcontainer">
            <div className="breweryCardcontainerUpper"> 
                <img className ="breweryCardImg" src='https://imgs.search.brave.com/xjs25IGx1dhPbD6ueLPad87O61xUBgTRbd8qeIHCFwQ/rs:fit:632:225:1/g:ce/aHR0cHM6Ly90c2Ux/Lm1tLmJpbmcubmV0/L3RoP2lkPU9JUC5N/aUZzel90dlB5R0Vw/VXpoSDFONkVRSGFG/aiZwaWQ9QXBp'
                alt="#"></img>
            </div>
